...
const initialValues: NetBanking = {
  bankName: "",
  accountNumber: "",
  ifscCode: "",
  password: "",
  ...
  return (
    <form onSubmit={handleSubmit}>
      <Stack spacing={3}>
        <FormControl
          height="90px"
          isInvalid={touched?.bankName && errors?.bankName ? true : undefined}
        >
        ...
        <FormControl
          height="90px"
          isInvalid={
            touched?.accountNumber && errors?.accountNumber ? true : undefined
          }
        >
        ...
        <FormControl
          height="90px"
          isInvalid={touched?.ifscCode && errors?.ifscCode ? true : undefined}
        >
